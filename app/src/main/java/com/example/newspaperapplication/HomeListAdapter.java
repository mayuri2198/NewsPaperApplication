...
public class HomeListAdapter extends RecyclerView.Adapter<HomeListAdapter.ViewHolder> {
    Context mContext;
    // Three types of context getapplication,getbaseclass,getactivity.
    //context is a abstract class.
    ArrayList<HashMap<String, String>> mArray;

    public HomeListAdapter(Context cxt, ArrayList<HashMap<String, String>> mArray) { //Adapter is used to show the contain in recycleview in xml file.
        this.mContext = cxt;
        this.mArray = mArray;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {  //A ViewHolder describes an item view and metadata about its place within the RecyclerView
            super(v);
